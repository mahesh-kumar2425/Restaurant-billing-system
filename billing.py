...
root.title("9 To 9 Resturent and cafe")
root.configure(background='cornsilk2')
Tops = Frame(root,bg='cornsilk2',bd=20,pady=5,relief=RIDGE)
Tops.pack(side=TOP)
lblTitle=Label(Tops,font=('arial',40,'bold'),text='Resturent Billing System',bd=21,bg='black',fg='cornsilk',justify=CENTER)
lblTitle.grid(row=0)
...
def CostofItem():
    ...
    FoodPrice =  "Rs",str('%.1f'%(PriceofFood))
    CostofFood.set(FoodPrice)
    CostofDrinks.set(DrinksPrice)
    SC = "Rs",str('%.1f'%(1.11))
    ServiceCharge.set(SC)
    SubTotalofITEMS = "Rs",str('%.1f'%(PriceofDrinks + PriceofFood + 1.11))
    SubTotal.set(SubTotalofITEMS)
    Tax = "Rs",str('%.1f'%((PriceofDrinks + PriceofFood + 1.11) * 0.09))
    PaidTax.set(Tax)
    TT=((PriceofDrinks + PriceofFood + 1.11) * 0.09)
    TC="Rs",str('%.1f'%(PriceofDrinks + PriceofFood + 1.11 + TT))
    TotalCost.set(TC)
def chkSprite():
    if(var1.get() == 1):
...
# ....................................................................................................................................
Sprite=Checkbutton(Drinks_F,text='Sprite',variable=var1,onvalue=1,offvalue=0,font=('arial',18,'bold'), bg='cornsilk2',command=chkSprite).grid(row=0,sticky=W)
Pepsi=Checkbutton(Drinks_F,text='Pepsi',variable=var2,onvalue=1,offvalue=0,font=('arial',18,'bold'), bg='cornsilk2',command=chkPepsi).grid(row=1,sticky=W)
DietCoke=Checkbutton(Drinks_F,text='DietCoke',variable=var3,onvalue=1,offvalue=0,font=('arial',18,'bold'), bg='cornsilk2',command=chk_DietCoke).grid(row=2,sticky=W)
Frappe=Checkbutton(Drinks_F,text='Frappe',variable=var4,onvalue=1,offvalue=0,font=('arial',18,'bold'),bg='cornsilk2',command=chk_Frappe).grid(row=3,sticky=W)
Cappuccino=Checkbutton(Drinks_F,text='Cappuccino',variable=var5,onvalue=1,offvalue=0,font=('arial',18,'bold'), bg='cornsilk2',command=chk_Cappuccino).grid(row=4,sticky=W)
Fanta=Checkbutton(Drinks_F,text='Fanta',variable=var6,onvalue=1,offvalue=0,font=('arial',18,'bold'), bg='cornsilk2',command=chk_Fanta).grid(row=5,sticky=W)
CocaCola=Checkbutton(Drinks_F,text='CocaCola',variable=var7,onvalue=1,offvalue=0,font=('arial',18,'bold'), bg='cornsilk2',command=chk_CocaCola).grid(row=6,sticky=W)
ColdCoffee=Checkbutton(Drinks_F,text='ColdCoffee',variable=var8,onvalue=1,offvalue=0,font=('arial',18,'bold'), bg='cornsilk2',command=chk_ColdCoffee).grid(row=7,sticky=W)
# ..........................................................................................................................
...
txtFrappe= Entry(Drinks_F,font=('arial',16,'bold'),bd=8,width=6,justify=LEFT,state=DISABLED,textvariable=E_Frappe)
...
# ..................................................................................................................................
PaneerTikka = Checkbutton(Food_F,text="PaneerTikka\t\t\t ",variable=var9,onvalue = 1, offvalue=0,font=('arial',16,'bold'),bg='cornsilk2',command=chk_PaneerTikka).grid(row=0,sticky=W)
VegBurger = Checkbutton(Food_F,text="VegBurger",variable=var10,onvalue = 1, offvalue=0,font=('arial',16,'bold'),bg='cornsilk2',command=chk_VegBurger).grid(row=1,sticky=W)
Pasta = Checkbutton(Food_F,text="Pasta ",variable=var11,onvalue = 1, offvalue=0,font=('arial',16,'bold'),bg='cornsilk2',command=chk_Pasta).grid(row=2,sticky=W)
HamBurger = Checkbutton(Food_F,text="Rice Plate ",variable=var12,onvalue = 1, offvalue=0,font=('arial',16,'bold'),bg='cornsilk2',command=chk_HamBurger).grid(row=3,sticky=W)
Sandwich = Checkbutton(Food_F,text="Sandwich ",variable=var13,onvalue = 1, offvalue=0,font=('arial',16,'bold'),bg='cornsilk2',command=chk_Sandwich).grid(row=4,sticky=W)
Fries = Checkbutton(Food_F,text="Fries ",variable=var14,onvalue = 1, offvalue=0, font=('arial',16,'bold'),bg='cornsilk2',command=chk_Fries).grid(row=5,sticky=W)
Noodles = Checkbutton(Food_F,text="Noodles ",variable=var15,onvalue = 1, offvalue=0, font=('arial',16,'bold'),bg='cornsilk2',command=chk_Noodles).grid(row=6,sticky=W)
Cake = Checkbutton(Food_F,text="Cake ",variable=var16,onvalue = 1, offvalue=0,font=('arial',16,'bold'),bg='cornsilk2',command=chk_Cake).grid(row=7,sticky=W)
# ...............................................................................................................................
txtPaneerTikka=Entry(Food_F,font=('arial',16,'bold'),bd=8,width=6,justify=LEFT,state=DISABLED,textvariable=E_PaneerTikka)
txtPaneerTikka.grid(row=0,column=1)
txtVegBurger=Entry(Food_F,font=('arial',16,'bold'),bd=8,width=6,justify=LEFT,state=DISABLED,textvariable=E_VegBurger)
...
txtNoodles=Entry(Food_F,font=('arial',16,'bold'),bd=8,width=6,justify=LEFT,state=DISABLED,textvariable=E_Noodles)
txtNoodles.grid(row=6,column=1)
txtCake=Entry(Food_F,font=('arial',16,'bold'),bd=8,width=6,justify=LEFT,state=DISABLED,textvariable=E_Cake)
txtCake.grid(row=7,column=1)
# .................................................................................................................................
lblCostofDrinks=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Drinks\t',bg='cornsilk2',fg='black',justify=CENTER)
...
lblCostofFood=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Foods  ',bg='cornsilk2',fg='black',justify=CENTER)
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='Service Charge',bg='cornsilk2',fg='black',justify=CENTER)
...
# ................................................................................................................................
lblPaidTax=Label(Cost_F,font=('arial',14,'bold'),text='\tPaid Tax',bg='cornsilk2',bd=7,fg='black',justify=CENTER)
lblPaidTax.grid(row=0,column=2,sticky=W)
txtPaidTax=Entry(Cost_F,bg='white',bd=7,font=('arial',14,'bold'),insertwidth=2,justify=RIGHT,textvariable=PaidTax)
txtPaidTax.grid(row=0,column=3)
lblSubTotal=Label(Cost_F,font=('arial',14,'bold'),text='\tSub Total',bg='cornsilk2',bd=7,fg='black',justify=CENTER)
...
lblTotalCost=Label(Cost_F,font=('arial',14,'bold'),text='\tTotal',bg='cornsilk2',bd=7,fg='black',justify=CENTER)
...
# ...........................................................................................................................................
btnTotal=Button(Buttons_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='Total',bg='cornsilk2',command=CostofItem).grid(row=0,column=0)
...
btnExit=Button(Buttons_F,padx=16,pady=1,bd=7,fg='black',font=('arial',16,'bold'),width=4,text='Exit',bg='cornsilk2',command=iExit).grid(row=0,column=3)
